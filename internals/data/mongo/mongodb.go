...
func Client() *mongo.Client {
	...
	mongodbClient.Database(os.Getenv(string(envConsts.MONGO_HISTORY_DATABASE_NAME))).Collection(string(envConsts.MONGO_HISTORY_DATABASE_APP_HISTORY_COLLECTION_NAME))
